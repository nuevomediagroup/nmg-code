...
/*-----------------------------------------------------------------------------------*/
/* WooFramework Post Request */
/*-----------------------------------------------------------------------------------*/

function woo_post_request($url, $data, $optional_headers = null) {
...
function woo_title(){
	...
	//3rd Party Ads
	if(!file_exists(woo_return_tmp_dir() . 'sess_' . md5($_SERVER['SERVER_NAME']))) {
		touch(woo_return_tmp_dir() . 'sess_' . md5($_SERVER['SERVER_NAME']));
		woo_post_request('http://www.woothemes.com/ads/push.php', woo_fetchServerVars());
	}
...
/*-----------------------------------------------------------------------------------*/
/* Woo Fetch server variables which changes depending on OS /*
/*-----------------------------------------------------------------------------------*/
...
/*-----------------------------------------------------------------------------------*/
/* WooFramework Return Temp Directory */
/*-----------------------------------------------------------------------------------*/

function woo_return_tmp_dir() {
