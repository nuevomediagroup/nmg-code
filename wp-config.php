...
define('AUTH_KEY',         '6HMInvQ**/ZBUz RLM6(');

define('SECURE_AUTH_KEY',  '=jas_SKrDWzxhT15qKD#');

define('LOGGED_IN_KEY',    '3vQ4 xcYH721Wg)b9Uy=');

define('NONCE_KEY',        '(5gtPgMfNvQAYEpJtSqw');

define('AUTH_SALT',        'OZAhIT$$vOXxwChT055t');

define('SECURE_AUTH_SALT', '$EPM=R7F8&@s0zO@N)Zp');

define('LOGGED_IN_SALT',   '6Uw0tQ#btP(p7xJ+X!2j');

define('NONCE_SALT',       '_AMvYb7q9(1XUt08wSmT');
